...
module.exports = {
  ...
  "💨 Vapes": [
    { name: "Engangs Vape 💨 — KOMMER SNART", price: 0, unit: "stk", description: "Engangs vape, klar til brug. Kommer snart — hold øjnene åbne!" }
  ],

  "🧴 THC Creme": [
    { name: "THC Creme 🧴 — KOMMER SNART", price: 0, unit: "glas", description: "Beroligende creme til huden. Kommer snart — hold øjnene åbne!" }
  ]
};
